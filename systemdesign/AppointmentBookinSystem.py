...
class Appointment:
    def __init__(self, appointment_id, customer_id, service_id, provider_id, date_time, status):
...
class AppointmentBookingSystem:
    ...
    def book_appointment(self, customer_id, service_id, provider_id, date_time):
        appointment_id = len(self.appointments) + 1
        appointment = Appointment(appointment_id, customer_id, service_id, provider_id, date_time, "Booked")
        self.appointments[appointment_id] = appointment
        return appointment
...
appointment = booking_system.book_appointment(customer.user_id, service.service_id, provider.user_id, "2023-08-20 10:00")

...
class Solution(object):
    def removeNthFromEnd(self, head, n):
        ...
        4. then advance both fast and slow as now they are nth postions apart, when fast gets to None, slow will be just before the item to be deleted
        5. remove the node i.e. next 0f slow becomes next of next of slow
        6. return head
        """
        slow, fast = head, head

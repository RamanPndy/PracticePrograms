class Solution(object):
    def isValid(self, s):
        ...
        2. traverse each character in string
            - if current character is in dictionary values i.e. closing bracket then append that character in stack
            - else if current character is in dictionary keys i.e. opening bracket

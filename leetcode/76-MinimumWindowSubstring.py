...
class Solution(object):
    def minWindow(self, s, t):
        ...
        5. If the current character in s is present in the frequency map and character count in current window and frequence map is same then increment the have.
        6. while have equals the need, it means we have found a window that contains all characters of t. 
          ...
          - if frequency of character at left in current window is less from frequency map then decrement have.
